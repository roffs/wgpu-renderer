use wgpu::{
    Device, Extent3d, Sampler, Texture, TextureDescriptor, TextureFormat, TextureUsages,
    TextureView,
};
...
impl CubeMap {
    ...
    //     label: Option<&str>,
    // ) -> CubeMap {
    //     let texture = CubeMap::new(device, width, height, format, usage, label);
